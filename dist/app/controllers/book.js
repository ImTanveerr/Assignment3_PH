...
exports.bookRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const body = req.body;
        const book = yield bookmodules_1.default.create(body);
        res.status(201).json({
            success: true,
...
exports.bookRouter.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let query = bookmodules_1.default.find(queryFilter);
        if (sortBy && sort) {
...
exports.bookRouter.get('/:bookId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const book = yield bookmodules_1.default.findOne({ _id: new Object(id) });
        res.status(201).json({
            success: true,
...
exports.bookRouter.patch('/:bookId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const book = yield bookmodules_1.default.findByIdAndUpdate(id, updatedDoc, { new: true });
        res.status(201).json({
            success: true,
...
exports.bookRouter.delete('/:bookId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = yield req.params.bookId;
        yield bookmodules_1.default.findByIdAndDelete(id);
        res.status(201).json({
            success: true,
